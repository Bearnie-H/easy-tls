...
#       an application building on the EasyTLS Server Framework. This is 
...
function helpMenu() {
    ...
    echo -e "
    $BLUE$scriptName   -   A bash tool to perform a basic build of the EasyTLS Server Framework.$WHITE
