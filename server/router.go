...
// NewRouter will create a new Router with ALL of the specified Routes and
// Middlewares, and update the SimpleServer with the registration information.
// This will NOT register the router, as more handlers and/or middlewares can
// be added following this function if necessary.
